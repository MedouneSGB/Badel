...
public class dataAccess {
    ...
    public void InsCol1(ModCol1 ndc) {
        try {
            ...
            PreparedStatement ps = JavaConnect.getPreparedStatement("insert into p1demandeurcollectif (idDC, formulaire_id, titre, nat_juridique, denomination, reconnaisance_juridique, pays, region, departement, commune, hors_senegal, date_creation, total_membre, total_homme, total_femme, inscritPar) values (NULL,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
            ...
            ps.setString(15, ndc.getInscritPar());
    ...
    public void addModInd1(ModInd1 mi1) {
        ...
        try {
            ...
            ps.setString(27, mi1.getInscritPar());
    ...
    public void updateInd1(ModInd1 mi1){
        ...
        try {
            PreparedStatement ps = JavaConnect.getPreparedStatement("UPDATE p1demandeurindividuel set prenom = ?,  nom = ?,  tel1 = ?,  tel2 = ?,  commune_rattach = ?,  commune_actuelle = ?,  sexe = ?,  tranche_age = ?,  etude = ?,  niveau_etude = ?,  formation_prof = ?,  sejour = ?,  pays_sejourne = ?,  motif_sejour = ?,  experience_prof = ?,  domaine_exp_prof = ?,  duree_exp_prof = ?,  statut_exp_prof = ?,  commune_exp_prof = ?,  departement_exp_prof = ?,  region_exp_prof = ?,  autre_region_exp_prof = ?,  hors_senegal = ?,  situation_prof = ?,  titre_accompagnement = ? where formulaire_id like ?");
            ...
            ps.setString(26, mi1.getFormulaire_id());
    ...
    public void updateInd3(ModInd3 mi3){
        try {
            System.out.println(mi3.getSoutien_immediat() + " " + mi3.getPays_parent());
            PreparedStatement ps = JavaConnect.getPreparedStatement("UPDATE p3demandeurindividuel set soutien_immediat = ?, regi_commerce = ?, numero_regi_comm = ?, ninea = ?, numero_ninea = ?, reference_prof = ?, numero_reference_prof = ?, compte_bancaire_sfd = ?, nom_banque_sfd = ?, numero_compte_banque_sfd = ?, soutien_parent = ?, ville_parent = ?, pays_parent  = ?  where formulaire_id like ? ");
    ...
    public void updateCol1(ModCol1 ndc){
        ...
        try {
            ...
            ps.setString(3, ndc.getDenomination());
            ps.setString(4, ndc.getReconnaisance_juridique());
            ps.setString(5, ndc.getPays());
            ps.setString(6, ndc.getRegion());
            ps.setString(7, ndc.getDepartement());
            ps.setString(8, ndc.getCommune());
            ps.setString(9, ndc.getHors_senegal());
            ps.setString(10, ndc.getDate_creation());
