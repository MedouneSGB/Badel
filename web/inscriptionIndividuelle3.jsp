<%-- 
    ...
    Created on : 14 déc. 2020, 01:30:04
    Author     : user
--%>
        ...
        <div id="at-wrapper" class="at-wrapper">
            ...
            <main id="at-main" class="at-main at-haslayout">
                ...
                <section class="at-sectionspace at-haslayout">
                    <div class="container">
                        <h1 style="text-align: center;">Inscription Individuelle 3 suite <%=formulaire_id%></h1>
                        <div class="row">
                                                   ...
                                                   <div class="row">
                                                       <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-left">
                                                           <div class="form-group">
                                                               ...
                                                               <option value="">- Qui étes vous ? -</option>
                                                               <option value="Demandeur">Je suis moi méme le demandeur</option>
                                                ...
                                                <div class="col-xs-12 col-sm-4 col-md-10 col-lg-10 pull-left">
                                                    <div class="form-group">
                                                        <select class="form-control" name="reference_prof" id="demo-category">
                                                            ...
                                                            <option value="autre">Autres é préciser</option>
                                                            <option value="NON">NON</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xs-12 col-sm-4 col-md-10 col-lg-10 pull-left">
                                                    <div class="form-group">
                                                        <select class="form-control" name="soutien_parent" id="demo-category">
                                                            <option value="">- Pour mener é bien votre projet avez-vous le soutien d'un parent ? -</option>
                                                            <option value="oui">OUI</option>
                                                            <option value="non">NON</option>
                                                        </select>
                                                    </div>
