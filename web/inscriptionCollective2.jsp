                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="at-content">
                                <div class="at-contactusvone">
                                    <form class="at-formtheme at-formcontacus" method="post" action="IndividVerif">
                                        ...
                                        <hr/>
                                              ...
                                              <h4><center><strong> Avez-vous des activit?s ou ?quipements dans la commune? </strong></center></h4>   
                                        <hr/>
                                         
                                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-left">
                                            <div class="form-group">
                                                <select class="form-control" name="activ_equip" id="demo-category" onchange="changementType( this.value);">
                                                <option value="">1- Avez-vous des activit?s ou ?quipements dans la commune? -</option>
                                        ...
                                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-left">
                                            <div class="form-group">
                                                <input type="text" name="activ_equip_depart" class="form-control" placeholder="2- Dans quelle d?partement ? ">
                                            </div>
                                        </div>  
                                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-left">
                                            <div class="form-group">
                                                <input type="text" name="activ_equip_region" class="form-control" placeholder="3- Dans quel r?gion ? ">
                                            </div>
                                        </div>  
                                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-left">
                                            <div class="form-group">
                                                <input type="text" name="activ_equip_autre_region" class="form-control" placeholder="4- Dans quelle autre r?gion ? ">
                                            </div>
                                        </div>   
                                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-left">
                                            <div class="form-group">
                                                <input type="text" name="activ_equip_hors_senegal" class="form-control" placeholder="5- Hors S?n?gal ? ">
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-left">
                                            <div class="form-group">
                                                <input type="text" name="" class="form-control" placeholder="NE PAS REMPLIR ? ">
                                            </div>
                                        </div>
                                        <fieldset>
                                            <div class="row">
                                        <hr/>
                                              <h4><center><strong>Quelles activit?s ?conomiques sont men?es par le Collectif ? </strong></center></h4>  
                                        <hr/>
                                         </fieldset>
                                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-12 pull-left">
                                            <div class="form-group">
                                                ...
                                                <option value="">- Quelles activit?s ?conomiques sont men?es par le Collectif ? -</option>
                                        ...
                                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-12 pull-left">
                                            <div class="form-group">
                                                <select class="form-control" name="sit_economique" id="demo-category" onchange="changementType( this.value);">
                                                <option value="">- Quelle est la situation ?conomique du Collectif ? -</option>
                                                <option value="Montant capital social (actuellement)">montant capital social (actuellement)</option>
                                                <option value="Nombre d'employ?s permanents (actuellement)">Nombre d'employ?s permanents (actuellement)</option>
                                                <option value="Nombre d'employ?s temporaires (actuellement)">Nombre d'employ?s temporaires (actuellement)</option>
                                                <option value="Montant ?pargne mobilis?e (3 derni?res ann?es)">Montant ?pargne mobilis?e (3 derni?res ann?es)</option>
                                                <option value="Montant endettement (3 derni?res ann?es)">Montant endettement (3 derni?res ann?es)</option>
                                                <option value="Montant subvention re?ue (3 derni?res ann?es)">Montant subvention re?ue (3 derni?res ann?es)</option>
                                                </select>
                                            </div>
                                        </div>
                                        <fieldset>
                                        ...
                                        <hr/>
                                              ...
                                              <h4><center><strong>Quelle est la situation de la gouvernance di Collectif ?</strong></center></h4>  
                                        <hr/>
                                         </fieldset>
                                                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-left">
                                                    <div class="form-group">
                                                        <input type="text" name="fonctionnalit?" class="form-control" placeholder="1- Fonctionnalit? des organes?">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-left">
                                                    <div class="form-group">
                                                        <input type="text" name="prise_decision" class="form-control" placeholder="2- Mode prise de d?cision?">
                                                    </div>
                                                </div>
                                               
                                                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-left">
                                                    <div class="form-group">
                                                        <input type="text" name="charte_membre" class="form-control" placeholder="3- Disponibilit? d'une charte des membres ?">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                    ...
                                                    <hr />
                                                    <h4><center><strong> Quelle Est La strat?gie partenariale Du Collectif ? </strong></center></h4> 
                                                    <hr />
                                                ...
                                                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-left">
                                                    <div class="form-group">
                                                        ...
                                                        <option value="">3 - Appartenance ? un r?seau? -</option>
                                                        <option value="OUI">OUI</option>
                                                        <option value="NON">NON</option>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-left">
                                                    <div class="form-group">
                                                        <input type="text" name="nature_reseau" class="form-control" placeholder="4- Nature R?seau ? ">
                                                    </div>
                                                </div>
                                                 
                                                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-left">
                                                    <div class="form-group">
                                                        <input type="text" name="localite_reseau" class="form-control" placeholder="5- Localit? du R?seau ? ">
                                                    </div>
                                                </div>
                                                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-left">
                                                    <div class="form-group">
                                                        <input type="text" name="departement_reseau" class="form-control" placeholder="6- Departement R?seau ? ">
                                                    </div>
                                                </div>
                                                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-left">
                                                    <div class="form-group">
