        ...
        <div id="at-wrapper" class="at-wrapper">
            ...
            <%
                ...
                try {
                    ...
                    String sql1 = "SELECT * FROM `p3demandeurindividuel` WHERE `formulaire_id` LIKE '" + formulaire_id + "'";
                    // String idx = "0";
                                        ...
                                        <form class="at-formtheme at-formcontacus" action="UpdateInd3" method="post" >
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="col-xs-12 col-sm-4 col-md-10 col-lg-10 pull-left">
                                                    <div class="form-group">
                                                        <input type="text" name="soutien_immediat" value="<%=form3In3%>" class="form-control" placeholder=" Quel soutien désirez-vous disposer dans l'immédiat?">
                                                    </div>
                                                </div>
                                                <div class="col-xs-12 col-sm-4 col-md-10 col-lg-10 pull-left">
                                                    <div class="form-group">
