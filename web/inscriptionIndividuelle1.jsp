                                        ...
                                        <form class="at-formtheme at-formcontacus" action="ServInd1" method="post">
                                            ...
                                            <fieldset>
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-left">
                                                        <div class="form-group">
                                                            <select class="form-control" name="experience_prof" id="demo-category" required>
                                                                <option value="">9- Avez-vous une Expérience Professionnelle ?** -</option>
                                                                <option value="OUI">OUI</option>                                                       
                                                                <option value="NON">NON</option>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-left">
                                                        <div class="form-group">
                                                            <select class="form-control" name="domaine_exp_prof" id="demo-category" required>
                                                                <option value="">10- Quelle est votre Domaine d'activité ?** -</option>
                                                    ...
                                                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-left">
                                                        <div class="form-group">
                                                            <select class="form-control" name="duree_exp_prof" id="demo-category" required> 
                                                                <option value="">11- Quelle est la Durée d'Expérience Professionnelle ?** -</option>
                                                    ...
                                                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-left">
                                                        <div class="form-group">
                                                            <input type="text" name="commune_exp_prof" class="form-control" placeholder="13- Commune d'activité :**" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-left">
                                                        <div class="form-group">
                                                            <input type="text" name="departement_exp_prof" class="form-control" placeholder="14- Département d'activité :**" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-left">
                                                        <div class="form-group">
                                                            <input type="text" name="region_exp_prof" class="form-control" placeholder="15- Région d'activité :**" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-left">
                                                        <div class="form-group">
